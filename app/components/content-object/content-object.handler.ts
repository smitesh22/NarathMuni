    ...
    switch (req.method) {
      ...
      case "GET":
        if (req.query.id) {
          ...
          const contentObject =
            await contentObjectService.getContentObjectById(id);
          if (!contentObject) {
          ...
          const contentObjects =
            await contentObjectService.getContentObjectByUser(userId);
      ...
      case "DELETE":
        ...
        const contentObject =
          await contentObjectService.deleteContentObjectById(id);
        res
          .status(204)
          .json({
            contentObject,
            message: "Content Object deleted successfully.",
          });
        break;
      default:
